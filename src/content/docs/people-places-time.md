...
description: Keep track of who's in the passage, where things happen, and when — like three running lists in your notebook.
order: 5
---
...
![The People tab showing Jesus, John the Baptist, and Moses, with verses grouped by chapter](../../assets/docs/people-places-time/people-places-time-01-people.png)
...
![The Places tab expanded, showing Bethany beyond the Jordan with its John 1:28 verse, and Galilee](../../assets/docs/people-places-time/people-places-time-02-places.png)
...
![The Time tab expanded, showing "In the beginning" at John 1:1 and "On the morrow" at John 1:29](../../assets/docs/people-places-time/people-places-time-03-time.png)
