...
description: Step back from your marked pages and see the whole book at once — then write down what it means and what to do about it.
order: 7
---
...
![The Chapter tab showing the title "The Word Became Flesh", section headings, and key words with counts — light 8, Word 4, believe 2](../../assets/docs/analyze/analyze-01-chapter.png)
...
![The Themes grid showing believe, Word, and light across John chapters 1 through 21](../../assets/docs/analyze/analyze-02-themes.png)
...
![The Interpret tab's empty state, inviting you to create your first entry](../../assets/docs/analyze/analyze-03-interpret.png)
