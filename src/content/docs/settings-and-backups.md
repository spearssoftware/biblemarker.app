...
description: Make the app comfortable — text size, fonts, translations — and keep your work safe with automatic backups.
order: 10
---
...
![The Appearance tab showing the Font Size and Scripture Font options](../../assets/docs/settings-and-backups/settings-and-backups-01-appearance.png)
...
![The Bible tab showing Offline Bible Modules, with licensed NASB downloads and public-domain translations](../../assets/docs/settings-and-backups/settings-and-backups-02-bible.png)
...
![The Backup & Sync tab showing Enable auto-backup, the backup interval, and Backup Statistics](../../assets/docs/settings-and-backups/settings-and-backups-03-backup.png)
