---
title: Lists & Flow
description: Gather what you're noticing into simple lists, and follow the "therefores" to see where the passage is heading.
order: 6
---
...
![The Lists tab showing a list called "Names of Jesus in John 1" with 5 verses](../../assets/docs/lists-and-flow/lists-and-flow-01-lists.png)
...
![The list expanded, showing entries like "the Word" and "the Lamb of God" with their verses](../../assets/docs/lists-and-flow/lists-and-flow-02-list-items.png)
...
![The Flow tab's empty state with the Create Your First Conclusion button](../../assets/docs/lists-and-flow/lists-and-flow-03-flow.png)
